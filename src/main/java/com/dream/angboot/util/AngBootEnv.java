...
public class AngBootEnv {
   ...
   static synchronized void init() {
      ...
      try {
         inp = new FileInputStream(configHome + "/angboot.properties");
      }
      catch(IOException ignore) {
         LOGGER.error("Found angboot.properties failed in {}.", configHome);
         inp = AngBootEnv.class.getResourceAsStream("/angboot.properties");
      }
